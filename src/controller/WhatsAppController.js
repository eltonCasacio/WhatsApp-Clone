...
export class WhatsAppController {
    ...
    setActiveChat(contact) {
        ...
        Message.getRef(this._contactActive.chatId).orderBy('timeStamp').onSnapshot(docs => {
            ...
            let panelMessages = this.el.panelMessagesContainer;

            let scrollTop = panelMessages.scrollTop;
            let scrollTopMax = (panelMessages.scrollHeight - panelMessages.offsetHeight);
            ...
            if (autoScroll) {
                ...
                panelMessages.scrollTop = (panelMessages.scrollHeight - panelMessages.offsetHeight);

            } else {

                panelMessages.scrollTop = scrollTop;
            }
        });
